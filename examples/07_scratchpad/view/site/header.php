...
<html>
<head>
<title><?php echo  $this->title ?> :: GLU Scratchpad</title>
...
<a href="<?php echo $this->selfurl .'/'; ?>">GLU Scratchpad</a> :: <?php echo $this->title; ?>
</h1>

<?php $this->dispatch($this->dir->VIEW . 'scratchpad/nav'); ?>
